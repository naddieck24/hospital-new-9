...
<div class="sidebar">
    <div class="sidebar-brand">
        <h2><img src="hospital.jpeg" alt="profile_img" width="75px" heigth="75px"> St. Therese</h2>
    </div>
    <div class="menu-wrapper">
        <div class="sidebar-menu" >
            <ul>
                    ...
                    <li>
                        <a href="check.php" class="nav-link"> <span class="fa-solid fa-check"></span><span></span>
            ...
            <form action="home">
                <div class="rooms">
                    <div class="room">
                        <div>
                            <h1>Private Room</h1> 
                            <a href="rooms/private.php" style="color:gray">Click here</a>
                        </div>
                    ...
                    <div class="room">
                        <div>
                            <h1>Semi Private Room</h1>
                            <a href="rooms/semiprivate.php" style="color:gray">Click here</a>
                        </div>
                    ...
                    <div class="room">
                        <div>  
                                ...
                                <br>
                                <br>                    
                                <a href="rooms/ward.php" style="color:gray";>Click here</a>
                        </div>
